      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="px-4 py-2 bg-surface border border-white/10 rounded-xl text-white focus:outline-none focus:border-accent transition-colors appearance-none cursor-pointer font-medium">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="glass-card rounded-2xl p-6">
            <h2 className="text-xl font-medium text-white mb-6 flex items-center gap-2">
              <Package className="w-5 h-5 text-zinc-400" /> Order Items
            </h2>
            ...
            <div className="space-y-4">
              ...
              <div
                key={idx}
                className="flex gap-4 p-4 bg-background border border-white/5 rounded-xl">
          ...
          <div className="glass-card rounded-2xl p-6">
              ...
              <p className="text-zinc-400 bg-background p-4 rounded-xl border border-white/5">
                {order.notes}
              </p>
            </div>
          }
        ...
        <div className="space-y-8">
          ...
          <div className="glass-card rounded-2xl p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="text-sm text-zinc-500 mb-1">Contact</div>
          ...
          <div className="glass-card rounded-2xl p-6">
            <h2 className="text-xl font-medium text-white mb-6 flex items-center gap-2">
              <Truck className="w-5 h-5 text-zinc-400" /> Delivery Method
            </h2>

            <div className="space-y-4">
              <div>
                <span className="inline-block px-3 py-1 bg-white/5 text-white rounded-full text-sm font-medium capitalize mb-4">
                  {order.deliveryType}
                </span>
              </div>
              ...
              <div>
                  ...
                  <div className="flex items-start gap-2 text-white bg-background p-4 rounded-xl border border-white/5">
