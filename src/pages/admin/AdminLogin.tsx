    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative">
      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          <div className="w-16 h-16 bg-surface border border-white/10 rounded-2xl flex items-center justify-center mx-auto mb-6 text-accent shadow-xl">
            <Store className="w-8 h-8" />
          </div>
          <h1 className="text-3xl font-serif text-white mb-2">
            {settings.storeName}
          </h1>
          <p className="text-zinc-400">Admin Portal Login</p>
        </div>
        ...
        <form
          ...
          <div className="space-y-2">
            <label className="text-sm text-zinc-400">Admin Password</label>
